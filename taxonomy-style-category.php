...
<body>
  ...
  <main>
    ...
    <div class="style-list__menu" ontouchstart="">
      <a class="style-list__menu-element" href="<?php echo get_post_type_archive_link('style'); ?>">
      ...
      foreach ($terms as $term) {
        echo '
        <a class="style-list__menu-element';
        if ($term->term_id == get_queried_object_id()) {
          echo ' --selected';
        }
        echo '" href="' . get_term_link($term->slug, 'style-category') . '">
